...
variable "region" {
  description = "GCP region. Pinned for UK/EU data residency."
  type        = string
...
variable "master_authorized_networks" {
  description = "Controlled networks permitted to reach the private control plane."
  type = list(object({
    cidr_block   = string
    display_name = string
  }))
